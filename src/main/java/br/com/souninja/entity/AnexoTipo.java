...
@Entity
@Table(name = "anexo_tipo")
public class AnexoTipo implements Serializable {
	...
	@Column(name = "aliquota_imposto")
	private Double aliquotaImposto;

	public AnexoTipo() {
	}

	public AnexoTipo(Integer id) {
		super();
		this.id = id;
	}
	...
	public String toString() {
		return "AnexoTipo [id=" + id + ", nome=" + nome + "]";
	}
